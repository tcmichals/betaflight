...
#define GYRO_1_CS_PIN           1
#define SPI_IO_CS_CFG 1
#define GYRO_1_SPI_INSTANCE     SPI_DEV_1_INSTANCE
#define USE_SPI_DEVICE_1
//TCM #define USE_EXTI
//TCM #define USE_GYRO_EXTI
#define GYRO_1_EXTI_PIN         2
...
#define I2C1_SCL                1        // SCL pad
#define I2C1_SDA                2        // SDA pad
#define DEFIO_TAG__1 1
#define DEFIO_TAG__2 2
...
#define SPI_DEV_1_INSTANCE ((SPI_TypeDef *)0x0001)
...
#define DEFIO_TAG__0            0
#define DEFIO_TAG__4            4
#define DEFIO_TAG__128          128
...
void linuxLedSet(int, bool);
void linuxLedToggle(int);
